  ...
  return (
    <div className="tv" style={{ overflowX: 'hidden', background: SAND }}>
      ...
      <style>{`
        ...
        .tv-eyebrow { display:inline-flex; align-items:center; gap:10px; margin:0; font-family:'Eloma Sans',sans-serif; font-weight:700; font-size:clamp(10px,0.8vw,12px); letter-spacing:2.5px; text-transform:uppercase; color:${TEAL}; }
        ...
        .tv-h2 { font-family:'Eloma Sans Heading',sans-serif; font-weight:700; font-size:clamp(30px,4.4vw,64px); line-height:1.12; letter-spacing:-0.035em; color:${NAVY}; margin:16px 0 0; padding-bottom:0.06em; }
        .tv-sec-head { max-width:900px; margin-bottom:clamp(38px,4.5vw,64px); }
        .tv-sec-p { font-family:'Eloma Sans',sans-serif; font-size:clamp(15px,1.2vw,18px); line-height:1.8; color:${MUTED}; margin:clamp(16px,1.8vw,24px) 0 0; max-width:60ch; }

        .tv-btn { display:inline-flex; align-items:center; gap:9px; cursor:pointer; font-family:'Eloma Sans Heading',sans-serif; font-weight:500; font-size:clamp(14px,1vw,16px); border-radius:12px; padding:15px 28px; border:none; text-decoration:none; transition:transform .25s cubic-bezier(0.16,1,0.3,1), background .25s ease, box-shadow .25s ease, color .25s ease, border-color .25s ease; }
        ...
        .tv-crumb { display:flex; align-items:center; justify-content:center; gap:9px; font-family:'Eloma Sans',sans-serif; font-size:clamp(11px,0.85vw,13px); color:rgba(255,255,255,0.6); margin-bottom:clamp(18px,2vw,26px); flex-wrap:wrap; }
        ...
        .tv-h1 { font-family:'Eloma Sans Heading',sans-serif; font-weight:700; font-size:clamp(40px,6.4vw,98px); line-height:1.06; letter-spacing:-0.04em; color:#fff; margin:clamp(16px,2vw,22px) 0 0; padding-bottom:0.04em; }
        .tv-lead-i { font-family:'Eloma Sans',sans-serif; font-size:clamp(15px,1.25vw,19px); line-height:1.8; color:rgba(255,255,255,0.78); max-width:56ch; margin:clamp(18px,2vw,26px) auto 0; }
        ...
        .tv-pass-stat-n { font-family:'Eloma Sans Heading',sans-serif; font-weight:700; font-size:clamp(26px,2.6vw,40px); letter-spacing:-0.04em; color:${TEAL}; line-height:0.9; }
        .tv-pass-stat-l { font-family:'Eloma Sans',sans-serif; font-size:clamp(11px,0.9vw,13px); letter-spacing:1px; text-transform:uppercase; color:${MUTED}; }
        ...
        .tv-pass-brand { display:inline-flex; align-items:center; gap:8px; font-family:'Eloma Sans Heading',sans-serif; font-weight:700; font-size:clamp(13px,1.1vw,16px); letter-spacing:1px; color:${TEAL}; }
        .tv-pass-class { font-family:'Eloma Sans',sans-serif; font-size:10px; font-weight:800; letter-spacing:2px; color:${MUTED}; border:1px solid rgba(18,49,58,0.18); border-radius:5px; padding:4px 9px; }
        ...
        .tv-pass-code { font-family:'Eloma Sans Heading',sans-serif; font-weight:700; font-size:clamp(30px,3.6vw,52px); letter-spacing:-0.03em; color:${NAVY}; line-height:0.9; }
        .tv-pass-place { font-family:'Eloma Sans',sans-serif; font-size:clamp(11px,0.9vw,13px); color:${MUTED}; margin-top:4px; }
        ...
        .tv-pass-k { font-family:'Eloma Sans',sans-serif; font-size:9.5px; font-weight:700; letter-spacing:1.2px; text-transform:uppercase; color:${MUTED}; }
        .tv-pass-v { font-family:'Eloma Sans Heading',sans-serif; font-weight:600; font-size:clamp(12px,1vw,14px); color:${NAVY}; }
        ...
        .tv-pass-stub-k { font-family:'Eloma Sans',sans-serif; font-size:9.5px; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; color:rgba(255,255,255,0.7); }
        .tv-pass-stub-v { font-family:'Eloma Sans Heading',sans-serif; font-weight:700; font-size:clamp(14px,1.2vw,18px); color:#fff; margin-bottom:6px; }
        ...
        .tv-card-t { font-family:'Eloma Sans Heading',sans-serif; font-weight:600; font-size:clamp(18px,1.6vw,24px); letter-spacing:-0.02em; color:${NAVY}; margin:0 0 10px; }
        .tv-card-d { font-family:'Eloma Sans',sans-serif; font-size:clamp(13.5px,1vw,15.5px); line-height:1.75; color:${MUTED}; margin:0; }
        ...
        .tv-gal-name { position:absolute; left:20px; bottom:18px; z-index:1; font-family:'Eloma Sans Heading',sans-serif; font-weight:600; font-size:clamp(15px,1.4vw,20px); letter-spacing:-0.01em; color:#fff; text-shadow:0 2px 12px rgba(0,0,0,0.4); }
        ...
        .tv-band-n { font-family:'Eloma Sans Heading',sans-serif; font-weight:700; font-size:clamp(36px,4.2vw,64px); line-height:0.9; letter-spacing:-0.045em; color:#6FD9E6; }
        .tv-band-l { font-family:'Eloma Sans',sans-serif; font-size:clamp(11px,0.9vw,14px); color:rgba(255,255,255,0.6); letter-spacing:0.3px; }
        ...
        .tv-check li { display:flex; align-items:center; gap:13px; font-family:'Eloma Sans Heading',sans-serif; font-weight:500; font-size:clamp(15px,1.2vw,18px); color:${NAVY}; }
        ...
        .tv-cta-h { font-family:'Eloma Sans Heading',sans-serif; font-weight:700; font-size:clamp(34px,5.6vw,84px); line-height:1.08; letter-spacing:-0.04em; color:#fff; margin:0; padding-bottom:0.04em; }
        .tv-cta-sub { font-family:'Eloma Sans',sans-serif; font-size:clamp(14px,1.15vw,17px); line-height:1.8; color:rgba(255,255,255,0.6); max-width:480px; margin:clamp(18px,2vw,26px) auto clamp(28px,3.5vw,40px); }
