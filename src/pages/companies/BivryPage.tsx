  ...
  return (
    <div className="bv" style={{ overflowX: 'hidden', background: '#fff' }}>
      ...
      <style>{`
        ...
        .bv-hl { color:${AMBER}; }
        .bv-eyebrow { display:inline-flex; align-items:center; gap:10px; margin:0; font-family:'Eloma Sans',sans-serif; font-weight:600; font-size:clamp(10px,0.8vw,12px); letter-spacing:2px; text-transform:uppercase; color:${AMBER2}; }
        ...
        .bv-h2 { font-family:'Eloma Sans Heading',sans-serif; font-weight:700; font-size:clamp(30px,4.2vw,60px); line-height:1.12; letter-spacing:-0.02em; color:${INK}; margin:16px 0 0; }
        .bv-sec-head { max-width:900px; margin-bottom:clamp(38px,4.5vw,64px); }
        .bv-sec-p { font-family:'Eloma Sans',sans-serif; font-size:clamp(15px,1.2vw,18px); line-height:1.8; color:${STEEL}; margin:clamp(16px,1.8vw,24px) 0 0; max-width:52ch; }
        ...
        .bv-crumb { display:flex; align-items:center; justify-content:center; gap:9px; font-family:'Eloma Sans',sans-serif; font-size:clamp(10px,0.82vw,12px); color:rgba(255,255,255,0.62); margin-bottom:clamp(20px,2.2vw,28px); flex-wrap:wrap; }
        ...
        .bv-h1 { font-family:'Eloma Sans Heading',sans-serif; font-weight:700; font-size:clamp(36px,5.4vw,82px); line-height:1.04; letter-spacing:-0.03em; color:#fff; margin:clamp(14px,2vw,20px) auto 0; max-width:24ch; text-shadow:0 2px 30px rgba(0,0,0,0.25); }
        .bv-lead { font-family:'Eloma Sans',sans-serif; font-size:clamp(15px,1.2vw,18px); line-height:1.8; color:rgba(255,255,255,0.82); max-width:52ch; margin:clamp(18px,2vw,26px) auto 0; }
        ...
        .bv-stat-n { font-family:'Eloma Sans Heading',sans-serif; font-weight:700; font-size:clamp(30px,3.4vw,54px); line-height:0.9; letter-spacing:0.01em; color:${AMBER}; }
        .bv-stat-l { font-family:'Eloma Sans',sans-serif; font-size:clamp(10px,0.85vw,12.5px); letter-spacing:0.5px; text-transform:uppercase; color:${STEEL}; }
        ...
        .bv-cap-badge-n { font-family:'Eloma Sans Heading',sans-serif; font-weight:700; font-size:clamp(34px,3.6vw,52px); line-height:0.9; color:${AMBER}; }
        .bv-cap-badge-l { font-family:'Eloma Sans',sans-serif; font-size:clamp(12px,1vw,14px); line-height:1.5; color:${STEEL}; }
        ...
        .bv-cap-n { font-family:'Eloma Sans',sans-serif; font-weight:600; font-size:13px; color:rgba(11,27,36,0.3); }
        .bv-cap-t { font-family:'Eloma Sans Heading',sans-serif; font-weight:700; font-size:clamp(19px,1.8vw,27px); letter-spacing:-0.01em; color:${INK}; margin:0 0 10px; }
        .bv-cap-d { font-family:'Eloma Sans',sans-serif; font-size:clamp(13.5px,1vw,15px); line-height:1.7; color:${STEEL}; margin:0; }
        ...
        .bv-promise-q { margin:clamp(22px,2.6vw,34px) 0 0; font-family:'Eloma Sans Heading',sans-serif; font-weight:700; font-size:clamp(30px,4.8vw,74px); line-height:1.12; letter-spacing:-0.02em; color:${INK}; }
        .bv-promise-by { margin:clamp(26px,3vw,40px) 0 0; font-family:'Eloma Sans',sans-serif; font-size:clamp(15px,1.3vw,20px); line-height:1.8; color:${STEEL}; max-width:64ch; }
        ...
        .bv-fleet-tag-n { font-family:'Eloma Sans',sans-serif; font-weight:600; font-size:13px; letter-spacing:1px; color:${AMBER2}; }
        .bv-fleet-tag-l { font-family:'Eloma Sans',sans-serif; font-size:12px; color:rgba(255,255,255,0.8); }
        ...
        .bv-fleet-chip-n { font-family:'Eloma Sans Heading',sans-serif; font-weight:700; font-size:clamp(18px,1.7vw,24px); color:${AMBER}; line-height:1; }
        .bv-fleet-chip-l { font-family:'Eloma Sans',sans-serif; font-size:10px; letter-spacing:0.5px; color:${STEEL}; margin-top:4px; }
        .bv-check { list-style:none; margin:clamp(24px,3vw,34px) 0 0; padding:0; display:flex; flex-direction:column; gap:15px; }
        .bv-check li { display:flex; align-items:center; gap:13px; font-family:'Eloma Sans',sans-serif; font-weight:500; font-size:clamp(15px,1.2vw,18px); color:${INK}; }
        ...
        .bv-cov-chip { display:inline-flex; align-items:center; gap:7px; font-family:'Eloma Sans',sans-serif; font-weight:500; font-size:clamp(13px,1vw,15px); color:${INK}; background:#fff; border:1px solid rgba(11,27,36,0.1); border-radius:999px; padding:9px 16px; transition:border-color .3s ease, color .3s ease; }
        ...
        .bv-cov-fig-n { display:block; font-family:'Eloma Sans Heading',sans-serif; font-weight:700; font-size:clamp(34px,4vw,60px); line-height:0.9; color:${INK}; }
        .bv-cov-fig-l { display:block; font-family:'Eloma Sans',sans-serif; font-size:clamp(12px,1vw,14px); color:${STEEL}; margin-top:6px; }
        ...
        .bv-cta-h { font-family:'Eloma Sans Heading',sans-serif; font-weight:700; font-size:clamp(34px,4.8vw,76px); line-height:1.06; letter-spacing:-0.02em; color:${INK}; margin:16px 0 0; }
        .bv-cta-act { display:flex; flex-direction:column; align-items:flex-start; gap:clamp(20px,2.4vw,28px); padding-bottom:6px; }
        .bv-cta-sub { font-family:'Eloma Sans',sans-serif; font-size:clamp(14px,1.15vw,17px); line-height:1.75; color:${STEEL}; margin:0; max-width:42ch; }
