      ...
      <section className="pt-asd">
        ...
        <div className="pt-wrap pt-asd-in">
          ...
          <motion.div className="pt-asd-visual" {...rise(0.1)}>
            <img src="/partner-logos/asd-lockup.png" alt="Australian Government - Australian Signals Directorate & Australian Cyber Security Centre (ACSC)" loading="lazy" decoding="async" />
          </motion.div>
        </div>
      </section>
